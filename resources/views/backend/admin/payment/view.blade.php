                                ...
                                <table id="paymentList" class="table table-striped table-bordered table-hover">
                                    ...
                                    <tbody>
                                    	<tr>
                                    		...
                                    		<td></td>
                                    		<td>
                                    			<a title='Edit' class='btn btn-success btn-circle editBtn' href=''></i></a>&nbsp&nbsp<a title='Delete' class='btn btn-danger btn-circle' href=''><i class='fa fa-trash-o'></i></a>
                                    		</td>
                                    		<td></td>
                                    	</tr>
                                    </tbody>
