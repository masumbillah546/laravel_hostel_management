...
<body>
    <div id="logreg-forms">
        <form class="form-signin" action="/lin" method="POST">
        	@csrf
            ...
            <input type="text" id="inputEmail" name="loginId" class="form-control" placeholder="User ID" required="" autofocus="">
            <input type="password" id="inputPassword" name="password" class="form-control" placeholder="Password" required="">
            @if(session('invalid'))
            <div class="alert alert-warning"><strong style="color: red">{{session('invalid')}}</strong></div>
            @endif
