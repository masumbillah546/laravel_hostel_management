...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        <div class="navbar-header">
            ...
            <img alt="HMS" class="pull-left" src="{{ asset('home.png') }}" width="40"><a class="navbar-brand titlehms" href=" echo $base_url.'edashboard.php'">Hostel Management System</a>
        </div>
        <!-- /.navbar-header -->
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li>
                <h5 class="titlehms"> Jashim Uddin</h5>
            </li>
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    <li><a href=" echo $base_url;ui/usr/profilee.php"><i class="fa fa-user fa-fw"></i>User Profile</a>
                    </li>
